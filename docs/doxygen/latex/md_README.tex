...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_ac8fb76879468f536845efd63dd013023}{EF\_UART\_enable}}(}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a906f9de6fa1f7d7a3e251f9c8ecf3ba1}{EF\_UART\_disable}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a27d08acb4a16fe736ec85a6809a8f4cf}{EF\_UART\_enableRx}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a8bbcb77cabef3983cca1118db94f33da}{EF\_UART\_disableRx}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a9e39d1b67dee9dc4eddecab799f2a73e}{EF\_UART\_enableTx}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a5fdfa5d0ceaf25c86265f08508d0ac82}{EF\_UART\_disableTx}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a5b6c1522111c36f052d01ef8477d8708}{EF\_UART\_enableLoopBack}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a14b502b1b4f32f74147fa27ef594ec5f}{EF\_UART\_disableLoopBack}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a41e9f0fc22054ed60435b56e07cc2b08}{EF\_UART\_enableGlitchFilter}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a0b951370140c22de50546112916dbf0f}{EF\_UART\_disableGlitchFilter}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a93420e961b8b16ec1d4e19565a89338f}{EF\_UART\_setCTRL}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_ae932a6f49dc8556119957adf2d230714}{EF\_UART\_getCTRL}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a417529a40a07f0af36ba658f3a31fff5}{EF\_UART\_setPrescaler}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a2d7077f683a7553f9c178ecfd058d1bd}{EF\_UART\_getPrescaler}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a29ad6f2b0288e0a90421b7755b4ea6d7}{EF\_UART\_setDataSize}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{int}\ value}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_ad9196d00146f379a9e90b260b4545209}{EF\_UART\_setTwoStopBitsSelect}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a61f34f093714af424473fa57fb04cfc5}{EF\_UART\_setParityType}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{enum}\ \mbox{\hyperlink{CF__UART_8h_aab5cbb4a185bfe65a14e19beeaba4f10}{parity\_type}}\ parity}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_ab56dac54958dce9684d6ad1cd26d1018}{EF\_UART\_setTimeoutBits}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{int}\ value}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a3af6fd4d87a613dcc940fd59c0a6e9fa}{EF\_UART\_setConfig}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_aae10f814cfbacb6ee771ddcc5b349744}{EF\_UART\_getConfig}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_ab453e751dd18f6e0893998ab546e0eb0}{EF\_UART\_setRxFIFOThreshold}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a829e9820f1d010624994aa7590851721}{EF\_UART\_getRxFIFOThreshold}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_aeb511962317eb5bcb55d2739f13e80ad}{EF\_UART\_setTxFIFOThreshold}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{int}\ threshold}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a6e89a406b1b3cff125032eff26043d3d}{EF\_UART\_getTxFIFOThreshold}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_ade8fde5e588c22e9bdf3b68f26469098}{EF\_UART\_setFIFOControl}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{int}\ value}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a044758d0138aeb24c6a87fda9c7de6c6}{EF\_UART\_getFIFOControl}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_ab67855784d50b5c547378f5d5702c273}{EF\_UART\_getTxCount}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_ad473ded49b92582489495c207b425a01}{EF\_UART\_getRxCount}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a24c0a12c701bbab2594a68148ccaf187}{EF\_UART\_getFIFOStatus}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a65715703fe82c3f9fb235cf6b0f62e7b}{EF\_UART\_setMatchData}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a471ea6bce689a667b0415208815a9005}{EF\_UART\_getMatchData}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_afb034e9ca5c75e87df32e77410dfffea}{EF\_UART\_getRIS}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a6ffee64b80995aff387251125ebeca80}{EF\_UART\_getMIS}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_af9fd462da652712e3d4c1a356af2b276}{EF\_UART\_setIM}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a19e91976fc7aa7bc0d7aea10f9092c82}{EF\_UART\_getIM}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a71cf6e226bdc78fa9e36f40b4039fe8e}{EF\_UART\_setICR}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{int}\ mask}
\DoxyCodeLine{)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a9219a3cffee150f100b55272eaae74da}{EF\_UART\_writeChar}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{CF__UART_8c_a45b53dbb72f6493a763d6176eb56ef2a}{EF\_UART\_writeCharArr}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{CF__UART_8c_a727b43ac98a06b2e2a0c31c305e3e2f9}{EF\_UART\_readChar}}(}
\DoxyCodeLine{\ \ \ \ uint32\_t\ uart\_base}
\DoxyCodeLine{)}
